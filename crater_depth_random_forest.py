...
# Initialize model
rf = RandomForestRegressor(featuresCol="scaledFeatures", labelCol="ln_Depth")
...
plt.ylabel('Depth (m)')
plt.title('Crater Depth Prediction using Random Forests, R²_validation = ' + str(round(r2_test,2)))

...
# Initialize model
dt = DecisionTreeRegressor(featuresCol="scaledFeatures", labelCol="ln_Depth")
...
plt.ylabel('Depth (m)')
plt.title('Crater Depth Prediction using Decision Trees, R²_validation = ' + str(round(r2_test,2)))

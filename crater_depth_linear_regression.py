...
print("Please ignore the warning about the pyspark ps command. It does not impact the performance of the code, and it will be removed in a future update.")
...
# Initialize model
lr = LinearRegression(featuresCol="scaledFeatures", labelCol="ln_Depth")
...
plt.ylabel('Depth (m)')
plt.title('Crater Depth Prediction using Linear Regression, R²_validation = ' + str(round(r2_test,2)))
...
print('Sample results can be found in the associated github directory on github/wliang463.')
